...
import cn.tedu.galaxy.order.common.AliPay;
import cn.tedu.galaxy.order.common.AlipayConfig;
    ...
    public String payNotify(HttpServletRequest request) throws Exception {
        if (request.getParameter("trade_status").equals("TRADE_SUCCESS")) {
            ...
            if (checkSignature) {
                ...
                Order result = orderMapper.getStandardById(Long.valueOf(outTradeNo));
                if (result!=null){
                    System.out.println("修改订单状态");
                    result.setGmtPay(LocalDateTime.now());
                    result.setState(1);
